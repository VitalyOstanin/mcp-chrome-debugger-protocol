...
describe('resolveGeneratedPosition', () => {
  ...
  describe('nested ../ path normalization', () => {
    // Source maps generated by build setups whose `sources` entries carry multiple leading
    // `../` segments. The resolver must strip ALL leading `../` to match user-provided
    // source paths (see CHANGELOG 1.1.1 "Source-map path normalisation").
