...
echo "2. Use Claude Code to connect with tool: connect_default"
echo "3. Set breakpoints and debug by triggering HTTP requests"
echo "4. Try conditional breakpoints and logpoints"
echo ""
echo "Available MCP tools:"
echo "- connect_default: Connect to debugger" 
echo "- set_breakpoint: Set breakpoint (with optional condition)"
echo "- set_logpoint: Set logpoint with custom message"
